...
The middle numbers represent the proportion of dead/survived members in a particular node (assuming the dependent attribute in the tree is "Survived")

The lowest number represents the percentage of members at the current node vs the entire dataset the tree was built on.
...
The rows represent if the "Survived" attribute is 0 or 1, i.e. if the passengers in the test set were predicted to survived or not. The columns represent if the passenger actually survived (1) or not (0).
